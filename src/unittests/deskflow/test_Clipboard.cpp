...
#include "test_Clipboard.h"

void Clipboard_Test::initTestCase()
{
  m_arch.init();
  m_log.setFilter(kDEBUG2);
}

void Clipboard_Test::basicFunction()
{
  Clipboard clipboard;
...
void Clipboard_Test::textSize285()
{
  std::string text;
...
void Clipboard_Test::marshalText()
{
  Clipboard clipboard;
  clipboard.open(0);
  clipboard.add(IClipboard::kText, kTestString1);
...
void Clipboard_Test::unMarshalText()
{
  Clipboard clipboard;
  std::string data;
  data += (char)0;
...
void Clipboard_Test::unMarshalText285()
{
  Clipboard clipboard;
...
void Clipboard_Test::unMarshalTextAndHtml()
{
  Clipboard clipboard;
  std::string data;
  data += (char)0;
...
void Clipboard_Test::equalClipboards()
{
